...
<body>
    ...
    <tbody>
        ...
        <a href="hapus_siswa.php?id=<?=$data_siswa['id'] ?>" onclick="return confirm('Are you sure you want to delete this item?') "class="btn btn-danger">Hapus</a>
        </td>
        </tr>
        <?php
        }
    ...
    <a href="tambah_siswa.php" class="btn btn-primary" style="float: right; width: 150px;">Tambah Siswa</a>
